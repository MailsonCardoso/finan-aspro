    ...
    <SidePanel open={open} onOpenChange={onOpenChange} title="Ficha de Controle de EPI">
      ...
      {selectedEmployee && (
        <div className="print-only p-8 text-black bg-white font-serif text-[12pt] leading-relaxed">
          ...
          <div className="mb-6">
            <p className="mb-4">O objetivo desta Guia é servir de meio de entrega e controle dos Equipamentos de Proteção Individual (EPIs) que ficarão aos cuidados do Colaborador abaixo identificado.</p>
            <p className="font-bold border-b border-black pb-1">Nome do Colaborador: {selectedEmployee.name}</p>
          </div>

          <p className="mb-6 text-[10pt]">O número do Certificado de Aprovação (CA) encontra-se impresso em caracteres indeléveis e bem visíveis no EPI e deverá ser verificado e confirmado através de rubrica do responsável pela entrega.</p>

          <div className="mb-6">
            <h4 className="font-bold mb-2 uppercase text-center border bg-gray-100 p-2">EPIs ENTREGUES NO PERÍODO</h4>
          ...
          <div className="text-[9pt] space-y-4 text-justify">
            <p>
              ...
              CNPJ: <strong>{settings?.company_cnpj || "( CNPJ DA EMPRESA )"}</strong>, os Equipamentos de Proteção Individual constantes da lista acima, 
          ...
          <div className="mt-12 pt-4 border-t border-black text-[7pt] text-gray-600 grid grid-cols-2 gap-4 leading-tight">
            <div>
              ...
              <p>Art. 462, § 1º - Em caso de dano causado pelo empregado, o desconto será lícito, desde que esta possibilidade tenha sido acordada ou na ocorrência de dolo do empregado.</p>
            </div>
            <div>
