        ...
        <SidePanel open={open} onOpenChange={onOpenChange} title="Ficha de Controle de EPI">
            ...
            {selectedEmployee && (
                <div className="print-only text-black bg-white font-serif text-[11pt] leading-tight">
                    ...
                    {/* SINGLE UNIFIED PAGE */}
                    <div className="print-page p-8 flex flex-col h-[210mm] justify-between">
                        <div>
                            <div className="text-center font-bold mb-4 uppercase border-b-2 border-black pb-2 text-[14pt]">
                                FICHA DE CONTROLE E TERMO DE RESPONSABILIDADE DE EPI
                            </div>

                            <div className="mb-4 grid grid-cols-2 gap-4">
                                <div className="border border-black p-2">
                                    <p className="text-[7pt] uppercase font-bold text-gray-600">Empresa / Empregador</p>
                                    <p className="font-bold text-[10pt]">{settings?.company_name || "( NOME DA EMPRESA )"}</p>
                                    <p className="text-[8pt]">CNPJ: {settings?.company_cnpj || "( CNPJ DA EMPRESA )"}</p>
                                </div>
                                <div className="border border-black p-2">
                                    <p className="text-[7pt] uppercase font-bold text-gray-600">Colaborador / Recebedor</p>
                                    <p className="font-bold text-[10pt]">{selectedEmployee.name}</p>
                                    <p className="text-[8pt]">Cargo: {selectedEmployee.role}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-6 flex-1">
                            ...
                            <div className="w-[55%] flex flex-col">
                                <h4 className="font-bold mb-1 uppercase text-center border-x border-t border-black bg-gray-100 p-1 text-[9pt]">RELAÇÃO DE EQUIPAMENTOS ENTREGUES</h4>
                                <table className="w-full border-collapse border border-black text-[8pt]">
                                    <thead>
                                        <tr className="bg-gray-50">
                                            ...
                                            <th className="border border-black p-1 text-center w-24">Data Entrega</th>
                                            <th className="border border-black p-1 text-center w-12">Qtd</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {assignments && assignments.length > 0 ? (
                                            ...
                                            <tr>
                                                <td colSpan={4} className="border border-black p-2 text-center italic text-gray-400">Nenhum EPI registrado no mês vigente.</td>
                                            </tr>
                                        )}
                                        {/* Empty rows to fill space */}
                                        {[...Array(Math.max(0, 8 - (assignments?.length || 0)))].map((_, i) => (
                                            <tr key={`empty-${i}`}>
                                ...
                                <div className="mt-4 text-[8.5pt] text-justify leading-snug">
                                    <p className="mb-2">
                            ...
                            <div className="w-[45%] flex flex-col text-[8pt] leading-tight space-y-3">
                                <div>
                                    <p className="font-bold text-[9pt] border-b border-black pb-1 mb-2 uppercase">Termo de Responsabilidade</p>
                                </div>

                                <div>
                                    <p className="font-bold">NR 06</p>
                                    <p className="font-semibold">6.7. Cabe ao empregado:</p>
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold">1.8. Cabe ao empregado:</p>
                                    ...
                                    <p className="font-semibold mt-1">1.8.1. Constitui ato faltoso a recusa injustificada do empregado ao cumprimento do disposto no item anterior.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-4">
                            <div className="grid grid-cols-2 gap-12">
                                ...
                                <div className="text-center pt-8">
                                    <div className="border-t border-black mb-1"></div>
                                    <p className="text-[9pt]">Assinatura do Colaborador: <strong>{selectedEmployee.name}</strong></p>
                                </div>
                            </div>
                            <div className="text-right text-[9pt] mt-4">
